// Backup of the main.rs (2022/01/19)
...
fn main() {
    ...
    let datasets = [
        ...
        // "colon-cancer.txt", "duke.txt", "leu.txt",
        // "mushrooms.txt", "madelon.txt",
        // "covtype.txt", "gisette_scale.txt",
        // "real-sim.txt", "rcv1_train.txt",
    ];
    ...
    for dataset in datasets {
        ...
        for capping_ratio in capping_ratios {
            ...
            {
                println!("\tRunning LPBoost for BddLtf...");
                let mut lpboost = LPBoost::init(&sample).capping(cap);

                // Initialize the base learner
                let start  = Instant::now();
                let base_learner = BddLtf::init(&sample);
    ...
    -> std::io::Result<()>
{
    ...
    let line = format!(
        "{},{},{},{},{},{},{},{},{},{}\n",
        dataset, m, dim, stump, capping, pre_process,
        running, iterate, loss, opt_val
    );
